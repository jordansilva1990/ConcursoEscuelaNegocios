...
<head>
  ...
  <title>Olimpiada de logistica</title>
</head>
  ...
  <div class="section">
    ...
    function tiempoEnd(){
      if(flag == 1){
       ...
       dataString = "action=correct&preg="+idPreg+"&alt="+1;
       $.ajax({
        url: "query/data1.php",
        data: dataString,
        type: "post",
   ...
   var id_alt="";
              ...
              swal({
               ...
               function(isConfirm){
                 if (isConfirm) {
                  ...
                  setTimeout(function(){
                    window.location.replace("logistica.php");
                  }, 5000);
                }
                else {
      ...
      // Start and stop are methods applied on the public TimeCircles instance
            ...
            $(".stopTimer").click(function() {
              ...
              function showswal(respuesta){
                swal({
                 title: "Se acabo el tiempo!",
                 text: "La respuesta correcta es: "+respuesta+ " Pasando a la siguiente pregunta!",
                 type: "warning",
                 showCancelButton: false,
                 confirmButtonColor: "#DD6B55",
                 confirmButtonText: "Siguiente!",
